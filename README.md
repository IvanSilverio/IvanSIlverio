...
## 🧠 Conhecimentos Teóricos & Fundamentos
- **Teoria dos Grafos:** Aplicação prática em algoritmos de recomendação e resolução de conflitos de otimização (como em grades horárias).
- **Algoritmos e Estruturas de Dados:** Foco em eficiência e lógica para a resolução de problemas complexos, aplicados tanto no back-end quanto no front-end.
- **Modelagem de Dados Relacionais:** Estruturação lógica e física de bancos de dados para garantir integridade e performance.

---

## 🛠️ Tech Stack, Frameworks & Ferramentas
...
<div align="center">
  ...
  <img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=IvanSilverio&layout=compact&theme=dracula&hide=jupyter%20notebook"/>
</div>
